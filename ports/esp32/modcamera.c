...
STATIC bool camera_init_helper(camera_obj_t *camera, size_t n_pos_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
    ...
    static const mp_arg_t allowed_args[] = {
        ...
        { MP_QSTR_d8,              MP_ARG_KW_ONLY                   | MP_ARG_INT,   {.u_int = CAM_PIN_D8} },
        { MP_QSTR_d9,              MP_ARG_KW_ONLY                   | MP_ARG_INT,   {.u_int = CAM_PIN_D9} },
    ...
    camera->config.pin_d6 = args[ARG_d8].u_int;
    camera->config.pin_d7 = args[ARG_d9].u_int;
